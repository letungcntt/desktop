...
import 'package:workcake/E2EE/key.dart';
...
class X25519 {
  ...
  static Int32List _constant121665 = () {
  ...
  Future<KeyP> calculateSharedSecret(KeyP secretKey, KeyP publicKey) async {
  ...
  KeyP calculateSharedSecretSync(KeyP secretKey, KeyP publicKey) {
  ...
  /// [generateKeyPairSync].
  Future<AsymmetricKeyPair> generateKeyPair({var seed}) async {
  ...
  AsymmetricKeyPair generateKeyPairSync({var seed}) {
    if (seed == null) {
    ...
    // Return a keypair
    final publicKey = KeyP.withPublicBytes(publicKeyBytes);
