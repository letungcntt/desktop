...
class ChatBubble extends StatefulWidget {
  ...
  final message, time, username, type, replyText, replyName;
  final isMe, isGroup, isReply;
...
class _ChatBubbleState extends State<ChatBubble> {
  ...
  Widget build(BuildContext context) {
    final bg = widget.isMe ? Theme.of(context).colorScheme.secondary : Colors.grey[200];
