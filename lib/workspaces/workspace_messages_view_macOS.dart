                        ...
                        child: InkWell(
                          child: Row(
                            ...
                            children: [
                              ...
                              Icon(PhosphorIcons.archive, size: 20, color: isDark ? Palette.defaultTextDark : Palette.defaultTextLight)
                            ],
                          ),
                      ...
                      child: Container(
                        ...
                        child: InkWell(
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Text(S.current.deleteWorkspace, style: TextStyle(color: Colors.redAccent),),
                              SvgPicture.asset(
                      ...
                      child: Container(
                        ...
                        child: InkWell(
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Text(S.current.leaveWorkspace, style: TextStyle(color: Colors.red)),
                              SvgPicture.asset(
      ...
      return Container(
        child: AlertDialog(
          ...
          content: Container(
            ...
            width: 528.0,
            child: Center(
              child: InviteMemberMacOS(type: 'toWorkspace', isKeyCode: false),
            )
          ),
        ),
      );
